...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mRed Hacker \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Aryan Mfc
    fi
    echo -e "\e[1;34m For Any Queries Join Me Whatsapp Group !!!\e[0m"
    echo -e "\e[1;32m           Whatsapp: https://chat.whatsapp.com/EDYp7k0AkGsB805gQKHF2G \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Aryan Mfc > .update
