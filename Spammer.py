...
def check_intr():
    try:
        ...
        bann_text()
        mesgdcrt.FailureMessage("Poor internet connection, try again")
        sys.exit(2)
...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From  https://github.com/Aryan-mfc/FastBomber.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull  https://github.com/Aryan-mfc/FastBomber.git HEAD")
    sys.exit()
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by Red Hacker")
...
__CONTRIBUTORS__ = ['Red Hacker', 'Aryan Mfc', 'Cyber Boy']
